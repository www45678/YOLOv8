...
def clip_coords(boxes, shape):
    ...
    Args:
        ...
        shape (tuple): The shape of the images. (height, width)
...
def scale_segments(img1_shape, segments, img0_shape, ratio_pad=None, normalize=False):
    ...
    Args:
      img1_shape (tuple): The shape of the images that the segments are from.
    ...
    Returns:
      segments (torch.Tensor): the segmented images.
    """
    if ratio_pad is None:  # calculate from img0_shape
        gain = min(img1_shape[0] / img0_shape[0], img1_shape[1] / img0_shape[1])  # gain  = old / new
        pad = (img1_shape[1] - img0_shape[1] * gain) / 2, (img1_shape[0] - img0_shape[0] * gain) / 2  # wh padding
...
def clip_segments(segments, shape):
    """
    It takes a list of line segments (x1,y1,x2,y2) and clips them to the images shape (height, width)
